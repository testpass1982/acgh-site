...
class Post(ContentMixin):
    ...
    publish_on_main_page = models.NullBooleanField(
        u"Опубликовать на главной", default=False
    )
    ...
    publish_in_basement = models.BooleanField(
        u"Опубликовать в подвале на главной", default=False
    )
...
class PostPhoto(models.Model):
    ...
    title = models.CharField(
        u"название", max_length=64, blank=True, default=get_image_filename
    )
...
class Contact(models.Model):
    ...
    email = models.EmailField(u"Адрес электронной почты", max_length=64, blank=False)
...
class Registry(models.Model):
    ...
    params = models.CharField(u"Параметры", max_length=999, blank=True)
...
class Service(models.Model):
    ...
    short_description = models.TextField(
        u"Краткое описание услуги", max_length=500, blank=True, null=True, default=None
    )
    html = RichTextUploadingField(u"Описание услуги")
    number = models.SmallIntegerField(
        u"Порядок сортировки", blank=True, null=True, default=None
    )
    bg_photo = models.ImageField(
        u"Картинка для главной",
        upload_to="upload/",
        null=True,
        blank=True,
        default=None,
    ...
    disable_order_button = models.BooleanField(
        u"Отключить кнопку подачи заявки", default=False
    )
...
class Profile(models.Model):
    ...
    org_logotype = models.ImageField(
        u"Логотип организации", upload_to="upload/", blank=True, null=True, default=None
    )
    ...
    org_short_name = models.CharField(
        u"Краткое название организации",
        max_length=100,
        blank=True,
        null=True,
        default=None,
    ...
    org_intro = models.TextField(
        u"Текст для главной страницы", blank=True, null=True, default=None
    )
    org_history = models.TextField(
        u"История организаици", blank=True, null=True, default=None
    )
    # phone1 for header
    org_main_phone = models.CharField(
        u"Главный телефон организации (используется в хедере)",
        max_length=100,
        blank=True,
        null=True,
        default=None,
    ...
    org_main_phone_text = models.CharField(
        u'Подпись под телефоном в хедере, например "Многоканальный"',
        max_length=30,
        blank=True,
        null=True,
        default=None,
    ...
    org_secondary_phone = models.CharField(
        u"Второй телефон организации (используется в хедере)",
        max_length=30,
        blank=True,
        null=True,
        default=None,
    ...
    org_secondary_phone_text = models.CharField(
        u'Подпись под вторым телефоном в хедере, например "Бухгалтерия"',
        max_length=30,
        blank=True,
        null=True,
        default=None,
    ...
    org_email = models.TextField(blank=True, null=True, default=None)
    org_email_secondary = models.TextField(blank=True, null=True, default=None)
    org_contacts_file = models.FileField(
        null=True,
        blank=True,
        upload_to="upload/",
    )
    ...
    org_order_email = models.CharField(
        u"Адреса для подключения формы заявки",
        max_length=100,
        blank=True,
        null=True,
        default=None,
    ...
    org_header_emails = models.TextField(
        u"Адреса электронной почты (для хедера)", blank=True, null=True, default=None
    )
    org_header_phones = models.TextField(
        u"Телефоны (для хедера)", blank=True, null=True, default=None
    )
    org_address = models.TextField(
        u"Адрес местоположения организации", null=True, blank=True, default=None
    )
    org_address_map_link = models.CharField(
        u"Ссылка на карту", blank=True, null=True, default=None, max_length=500
    )
    org_ur_address = models.TextField(
        u"Юридический адрес", null=True, blank=True, default=None
    )
    org_work_time = models.CharField(
        u"Время работы организации", null=True, blank=True, default=None, max_length=100
    )
    org_csp_code = models.CharField(
        u"шифр ЦСП (необязательно)", max_length=20, null=True, blank=True
    )
    org_csp_reestr_link = models.URLField(
        u"Ссылка на реестр ЦСП", blank=True, null=True
    )
    org_acsp_code = models.CharField(
        u"шифр АЦСП (необязательно)", max_length=20, null=True, blank=True
    )
    org_acsp_reestr_link = models.URLField(
        u"Ссылка на реестр АЦСП", blank=True, null=True
    )
    org_acsm_code = models.CharField(
        u"шифр АЦСМ (необязательно)", max_length=20, null=True, blank=True
    )
    org_acsm_reestr_link = models.URLField(
        u"Ссылка на реестр АЦСМ", blank=True, null=True
    )
    org_acso_code = models.CharField(
        u"шифр АЦСО (необязательно)", max_length=20, null=True, blank=True
    )
    org_acso_reestr_link = models.URLField(
        u"Ссылка на реестр АЦСО", blank=True, null=True
    )
    org_acst_code = models.CharField(
        u"шифр АЦСТ (необязательно)", max_length=20, null=True, blank=True
    )
    org_acst_reestr_link = models.URLField(
        u"Ссылка на реестр АЦСТ", blank=True, null=True
    )
    org_cok_code = models.CharField(
        u"шифр ЦОК (необязательно)", max_length=20, null=True, blank=True
    )
    org_cok_reestr_link = models.URLField(
        u"Ссылка на реестр ЦОК", blank=True, null=True
    )
    add_ap_list = models.BooleanField(
        u"Добавить ссылку на список пунктов", default=False
    )
    add_schedule = models.BooleanField(
        u"Добавить ссылку на график аттестации", default=False
    )
...
class Chunk(models.Model):
    ...
    code = models.CharField(
        u"Уникальный код вставки", max_length=64, default="КОД_ВСТАВКИ"
    )
...
class Font(models.Model):
    title = models.CharField(
        u"Название шрифта", default=None, blank=True, null=True, max_length=30
    )
    font_url = models.CharField(
        u"Ссылка на шрифт", default=None, blank=True, null=True, max_length=200
    )
...
class SiteConfiguration(models.Model):
    ...
    title = models.CharField(
        u"Название конфигурации", default="Конфигурация 1", max_length=30
    )
    site_type = models.CharField(
        u"Тип сайта", max_length=1, choices=SITE_TYPES, blank=True, default=None
    )
    ...
    current_color_set = models.CharField(
        u"Текущие цвета",
        default="#151A18, #E3C4D2, #D6ABBF, #D2E0FF, #968EAF",
        max_length=50,
    )
    ...
    def update_current_component_set(self):
        if len(Component.objects.all()) > 0:
            self.current_component_set = " ".join(
                [c.title for c in Component.objects.filter(configuration=self.pk)]
            )
            self.save()
...
class Component(models.Model):
    ...
    js = models.FileField(
        u"Файл скриптов", null=True, blank=True, default=None, upload_to="components/"
    )
    html_path = models.CharField(
        u"Путь к файлу разметки", blank=True, null=True, max_length=300, default=""
    )
    relative_html_path = models.CharField(
        u"Относительный путь к файлу разметки",
        blank=True,
        null=True,
        max_length=300,
        default="",
    )
    scss_path = models.CharField(
        u"Путь к файлу стилей", blank=True, null=True, max_length=300, default=""
    )
    relative_scss_path = models.CharField(
        u"Относительный путь к файлу стилей",
        blank=True,
        null=True,
        max_length=300,
        default="",
    ...
    js_path = models.CharField(
        u"Путь к файлу скрипта", blank=True, null=True, max_length=300, default=""
    )
    relative_js_path = models.CharField(
        u"Относительный путь к файлу скрипта",
        blank=True,
        null=True,
        max_length=300,
        default="",
    ...
    configuration = models.ForeignKey(
        SiteConfiguration, blank=True, null=True, on_delete=models.SET_NULL
    )
...
class OrderService(models.Model):
    ...
    text = models.TextField(
        u"Вопрос из формы", max_length=500, default=None, blank=True, null=True
    )
    pdn_accept = models.BooleanField(u"Согласие на обработку ПДн")
    compound = models.CharField(
        u"Состав заявки", max_length=300, default=None, blank=True, null=True
    )
...
class SlideBackgrounds(models.Model):
    title = models.CharField(u"Название", default="Слайдер", max_length=50)
    image = StdImageField(
...
class Advert(models.Model):
    ...
    url_code = models.CharField(
        u"Код ссылки (для привязки к странице сайта)",
        max_length=20,
        blank=True,
        null=True,
    )
    ...
    url_text = models.CharField(
        u"Текст для ссылки", max_length=100, blank=True, null=True
    )
